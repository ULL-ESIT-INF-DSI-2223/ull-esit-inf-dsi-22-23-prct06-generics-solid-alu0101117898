...
describe("StringPrintableCollection class tests", () => {
  it("StringPrintableCollection returns 'seis', 'siete', 'ocho', 'nueve', 'diez'", () => {
    expect(coleccionCadenas.print()).to.be.eqls(['seis', 'siete', 'ocho', 'nueve', 'diez']);
  });
  it("StringPrintableCollection returns 'uno', 'dos', 'tres', 'cuatro', 'cinco'", () => {
